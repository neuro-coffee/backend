    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('basket', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='user', to='products.basketmodel', verbose_name='корзина')),
